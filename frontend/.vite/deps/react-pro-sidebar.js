...
var SidebarContext = import_react.default.createContext(void 0);
var SidebarProvider = function(_a) {
  var children = _a.children;
  var _b = import_react.default.useState(), sidebarState = _b[0], setSidebarState = _b[1];
  ...
  return import_react.default.createElement(SidebarContext.Provider, { value: providerValue }, children);
};
var useSidebar = function() {
  var context = import_react.default.useContext(SidebarContext);
  if (context === void 0) {
...
var useMediaQuery = function(breakpoint) {
  var _a = import_react.default.useState(breakpoint === "always"), matches = _a[0], setMatches = _a[1];
  import_react.default.useEffect(function() {
    if (breakpoint && breakpoint !== "always") {
      ...
      var listener_1 = function() {
        return setMatches(media_1.matches);
      };
      window.addEventListener("resize", listener_1);
      return function() {
        return window.removeEventListener("resize", listener_1);
      };
    }
  }, [matches, breakpoint]);
  return matches;
...
var SidebarFR = function(_a, ref) {
  ...
  return import_react.default.createElement(
    StyledSidebar,
    __assign({ ref, "data-testid": "".concat(sidebarClasses.root, "-test-id"), rtl: rtlContext, rootStyles, width: widthContext, collapsedWidth: collapsedWidthContext, transitionDuration: transitionDurationContext !== null && transitionDurationContext !== void 0 ? transitionDurationContext : 300, className: classnames(sidebarClasses.root, (_b = {}, _b[sidebarClasses.collapsed] = collapsedContext, _b[sidebarClasses.toggled] = toggledContext, _b[sidebarClasses.broken] = brokenContext, _b[sidebarClasses.rtl] = rtlContext, _b), className) }, rest),
    ...
    brokenContext && toggledContext && import_react.default.createElement(StyledBackdrop, { "data-testid": "".concat(sidebarClasses.backdrop, "-test-id"), role: "button", tabIndex: 0, "aria-label": "backdrop", onClick: handleBackdropClick, onKeyPress: handleBackdropClick, className: sidebarClasses.backdrop })
  );
};
var Sidebar = import_react.default.forwardRef(SidebarFR);
...
var SubMenuContentFR = function(_a, ref) {
  ...
  var _b = import_react.default.useState(false), mounted = _b[0], setMounted = _b[1];
  import_react.default.useEffect(function() {
    clearTimeout(timer);
    if (mounted) {
      if (open) {
  ...
  return import_react.default.createElement(
    ...
    __assign({ "data-testid": "".concat(menuClasses.subMenuContent, "-test-id"), ref, firstLevel, collapsed, open, openWhenCollapsed, transitionDuration }, rest),
    import_react.default.createElement(StyledUl, null, children)
  );
};
...
var SubMenuFR = function(_a, ref) {
  ...
  var _h = import_react.default.useState(!!defaultOpen), open = _h[0], setOpen = _h[1];
  var _j = import_react.default.useState(!!defaultOpen), openDefault = _j[0], setOpenDefault = _j[1];
  var _k = import_react.default.useState(false), openWhenCollapsed = _k[0], setOpenWhenCollapsed = _k[1];
  var childNodes = import_react.default.Children.toArray(children).filter(Boolean);
  ...
  var getSubMenuItemStyles = function(element) {
    if (menuItemStyles) {
      var params = { level, disabled, active, isSubmenu: true, open: openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open };
  ...
  import_react.default.useEffect(function() {
    var handleTogglePopper = function(target) {
      ...
      else if (closeOnClick && !((_b2 = target.closest(".menu-item")) === null || _b2 === void 0 ? void 0 : _b2.classList.contains("sub-menu")) || !((_c2 = contentRef.current) === null || _c2 === void 0 ? void 0 : _c2.contains(target)) && openWhenCollapsed) {
        setOpenWhenCollapsed(false);
      }
    };
  ...
  var sharedClasses = (_b = {}, _b[menuClasses.active] = active, _b[menuClasses.disabled] = disabled, _b[menuClasses.open] = openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open, _b);
  return import_react.default.createElement(
    StyledSubMenu,
    ...
    import_react.default.createElement(
      ...
      prefix2 && import_react.default.createElement(StyledMenuPrefix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getSubMenuItemStyles("prefix") }, prefix2),
      ...
      suffix && import_react.default.createElement(StyledMenuSuffix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getSubMenuItemStyles("suffix") }, suffix),
      ...
      }) : collapsed && level === 0 ? import_react.default.createElement(StyledExpandIconCollapsed, null) : import_react.default.createElement(StyledExpandIcon, { rtl, open: openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open }))
    ),
    import_react.default.createElement(SubMenuContent, { ref: contentRef, openWhenCollapsed, open: openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open, firstLevel: level === 0, collapsed, defaultOpen: openDefault, className: classnames(menuClasses.subMenuContent, sharedClasses), rootStyles: getSubMenuItemStyles("subMenuContent") }, childNodes.map(function(node2) {
      return import_react.default.cloneElement(node2, __assign(__assign({}, node2.props), { level: level + 1 }));
    }))
  );
};
...
var useProSidebar = function() {
  ...
  var collapseSidebar = import_react.default.useCallback(function(value) {
    if (value === void 0)
      updateCollapseState();
    else
      updateSidebarState({ collapsed: value });
  }, [updateCollapseState, updateSidebarState]);
  var toggleSidebar = import_react.default.useCallback(function(value) {
    if (value === void 0)
      updateToggleState();
    else
